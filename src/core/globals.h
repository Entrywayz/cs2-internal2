...
namespace globals {
	...
	inline float ViewMatrix[16] = { .0f };
	inline Vec3 viewAngles = { 0, 0, 0 };
	inline bool boxEnabled = false;
	inline bool healthEnabled = false;
	inline bool nameEnabled = false;
	inline float boxCol[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
	inline float nameCol[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
	inline float skelCol[4] = { 1.0f, 1.0f, 1.0f, 1.0f };
	inline float skelThick = 0.0f;
}